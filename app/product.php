...
class product extends db{
	...
	public function editproduct($brand, $name, $detail, $price, $img, $id){
		if($img == NULL){
			$sql = "UPDATE products SET brand = '$brand', details = '$detail', name = '$name', price = '$price' WHERE id = $id";
		}
		else{
			$sql = "UPDATE products SET brand = '$brand', details = '$detail', name = '$name', price = '$price', img = '$img' WHERE id = $id";
		}
